...
sender_name = 'Devman'
recepient_email = 'biga4e@gmail.com'
...
Укажи в форме %website% неделю и удобное время для созвонов'''.replace('%student_name%', recepient_name).replace('%website%', website)
...
login = 'devmanyourproject@yandex.ru'
# password = os.environ['YANDEX_PASSWORD']
password = 'zokgmfgbjqcjerrz'
